...
class ProfileUpdateFragment : Fragment() {
    ...
    private fun initFields(user : UserDTO?) {
        var sdf : SimpleDateFormat? = SimpleDateFormat(getString(R.string.sdf_date))
    ...
    private fun update(view : View){
        ...
        if(validate()) {
            ...
            var sdfApi : SimpleDateFormat? = SimpleDateFormat(getString(R.string.sdf_api_date))
            var sdfView : SimpleDateFormat? = SimpleDateFormat(getString(R.string.sdf_date))
            var birthDate = sdfView?.parse(txtBirthDate?.text.toString())
            ...
            userService.update(actualUserDto?.id.toString(), updatedUserDto, UserAccount.getInstance(requireContext()).getToken()).enqueue(object : Callback<Void> {
